...
INSERT INTO owners (first_name, last_name, address, city, telephone) SELECT 'George', 'Nafiz', '110 W. Liberty St.', 'Madison', '6085551023' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=1);
